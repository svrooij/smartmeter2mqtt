...
const P1Map = [
  ...
  { id: '1-0:52.32.0', name: 'voltageSagsL2', valueRetriever: parseFirstInt },
  { id: '1-0:72.32.0', name: 'voltageSagsL3', valueRetriever: parseFirstInt },
  { id: '1-0:32.36.0', name: 'voltageSwellsL1', valueRetriever: parseFirstInt },
  { id: '1-0:52.36.0', name: 'voltageSwellsL2', valueRetriever: parseFirstInt },
  { id: '1-0:72.36.0', name: 'voltageSwellsL3', valueRetriever: parseFirstInt },
  { id: '1-0:31.7.0', name: 'currentL1', valueRetriever: parseFirstFloat },
  { id: '1-0:51.7.0', name: 'currentL2', valueRetriever: parseFirstFloat },
  { id: '1-0:71.7.0', name: 'currentL3', valueRetriever: parseFirstFloat },
  { id: '1-0:21.7.0', name: 'currentUsageL1', valueRetriever: parseFirstFloat },
  { id: '1-0:41.7.0', name: 'currentUsageL2', valueRetriever: parseFirstFloat },
  { id: '1-0:61.7.0', name: 'currentUsageL3', valueRetriever: parseFirstFloat },
  { id: '1-0:22.7.0', name: 'currentDeliveryL1', valueRetriever: parseFirstFloat },
  { id: '1-0:42.7.0', name: 'currentDeliveryL2', valueRetriever: parseFirstFloat },
  { id: '1-0:62.7.0', name: 'currentDeliveryL3', valueRetriever: parseFirstFloat },
